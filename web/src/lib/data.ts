...
export const sampleConvo = [
  ...
  },
  {
    ...
    message: 'Thank you, Maximo. I appreciate it!',
    dp: myDp,
  },
  {
    sender: 'Maximo Guzman',
    message:
      'In my experience, being disciplined and passionate about the industry are some of the most important traits for a developer. Would you agree?',
    dp: sampleChatDp,
  },
  {
    sender: 'Nathan Flores',
  ...
  },
  {
    sender: 'Maximo Guzman',
    message:
      'You seem to embody all of those traits, which is why I think you would be a valuable member of our company.',
    dp: sampleChatDp,
  },
  {
    sender: 'Nathan Flores',
